...
let arrayOfPosibleMessages=[
    ...
    {message:"Sobre la carrera Ingenieria de Sistemas",response:"Opciones: Requerimientos, Carga Horaria, Pensiones, Horarios, Duración de la carrera, Materias"},
    {message:"Requerimientos de Ingenieria de Sistemas",response:"Si eres nuevo, se requiere el título de bachiller, fotocopias del carnet y pagar la matrícula de 1000 Bs."},
    {message:"Carga Horaria de Ingenieria de Sistemas",response:"La carga horaria es de 16 horas y 15 minutos por semana."},

    {message:"Pensiones de Ingenieria de Sistemas",response:"La mensualidad es de 850 Bs mensualmente."},
